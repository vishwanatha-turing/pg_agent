...
Given a problem statement, generate 60 diverse and challenging test cases that:

- Covers 10 extreme upper limit and lower limit test cases(give all the values do not use "....." in test cases)
