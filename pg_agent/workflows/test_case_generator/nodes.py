...
def _extract_cpp_code(response_content: str):
...
def _create_generation_node(prompt_file_name: str, output_key: str, version_key: str):
    """A factory to create a node that generates and saves a versioned C++ script."""
...
# Corrected the typo from "Generatior" to "Generator"
