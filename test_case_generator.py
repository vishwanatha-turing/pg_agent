...
def test_case_generator_node(state):
    ...
    # Return the test cases to be added to state
    return {"test_cases": [test_cases]}  # Wrapped in list for add reducer
